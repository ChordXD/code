...
static 	$DB_PASS="rZEQfzrPdyP0sX5d";  //数据库密码

static 	$OJ_NAME="HRBUST-Royal-230-OJ";  //左上角显示的系统名称
static 	$OJ_HOME="./";    //主页目录
...
static  $OJ_TEMPLATE="newgui"; //使用的默认模板, [bs3 ie ace sweet sae] work with discuss3, [classic bs] work with discuss
